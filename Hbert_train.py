...
def define_argparser():
    ...
    p.add_argument('--model_fn', default='1.pth')
    p.add_argument('--train_fn', default='/home/jwp/project/HBERT/data/train.hate.csv')
    p.add_argument('--val_fn', default='/home/jwp/project/HBERT/data/dev.hate.csv')
